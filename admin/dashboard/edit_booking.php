...
if($_SESSION['login_status']!="true")
{
    ...
    else
    {
        ...
        $queryexe=mysqli_fetch_array($query);
        $name=$queryexe['name'];
        $email=$queryexe['email'];
        $gender=$queryexe['gender'];
        $phno=$queryexe['phno'];
        $arrival=$queryexe['arrival'];
        $departure=$queryexe['departure'];
        $adults=$queryexe['adults'];
        $children=$queryexe['children'];
        $roomtype=$queryexe['roomtype'];
        $paymentstatus=$queryexe['status'];
        $address=$queryexe['address'];
        if($effect==0)
        {
            header('location:index.php');
        }
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
             ...
             <form action="../../function/editbooking.php?id=<?php echo $id;?>" method='post'>
                     <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="card-head">
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-6 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input class = "mdl-textfield__input" type = "text" name='name' value="<?php echo ucfirst($name); ?>" id = "txtFirstName" required >
                                     ...
                                     <div class="col-lg-6 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input class = "mdl-textfield__input" type = "email" name='email' id = "txtemail" value="<?php echo ucfirst($email); ?>" required>
                                     ...
                                     <div class="col-lg-6 p-t-20"> 
                                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input class="mdl-textfield__input" type="text" id="sample2" value="<?php echo ucfirst($gender); ?>"  tabIndex="-1" name="gender" required>
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                       <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input class = "mdl-textfield__input" type = "text" 
                                            pattern = "-?[0-9]*(\.[0-9]+)?" value="<?php echo ($phno); ?>" id = "text5" required name="phno">
                                    ...
                                    <div class="col-lg-6 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input class = "mdl-textfield__input" type = "date" name="arrival" value="<?php echo ($arrival); ?>" required >
                                    ...
                                    <div class="col-lg-6 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input class = "mdl-textfield__input" type = "date" name="departure" value="<?php echo ($departure); ?>" required>
                                      ...
                                      <div class="col-lg-6 p-t-20"> 
                                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input class="mdl-textfield__input" type="text" name="adults" id="list5" value="<?php echo ucfirst($adults); ?>"  tabIndex="-1" required>
                                             <span class = "mdl-textfield__error">Choose One</span>
                                     ...
                                     <div class="col-lg-6 p-t-20"> 
                                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input class="mdl-textfield__input" type="text" id="list2" name="children" value="<?php echo ($children); ?>"  tabIndex="-1" required>
                                             <span class = "mdl-textfield__error">Choose One</span>
                                    ...
                                    <div class="col-lg-6 p-t-20"> 
                                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input class="mdl-textfield__input" type="text" id="list3" value="<?php echo ucfirst($roomtype); ?>" name='roomname'  tabIndex="-1" required>
                                             <span class = "mdl-textfield__error">Choose One</span>
                                    ...
                                    <div class="col-lg-6 p-t-20"> 
                                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input class="mdl-textfield__input" type="text" id="list10" value="<?php echo ucfirst($paymentstatus); ?>" name='payment'  tabIndex="-1" required>
                                             <span class = "mdl-textfield__error">Choose One</span>
                                    ...
                                    <div class="col-lg-12 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield txt-full-width">
                                         <textarea class = "mdl-textfield__input" name='address' rows =  "4" 
                                            id = "text7"  required><?php echo ucfirst($address); ?></textarea>
                                     ...
                                     <div class="col-lg-12 p-t-20 text-center"> 
                                        <input type="submit" value='save' class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">
