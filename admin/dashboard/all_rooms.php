                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">View All Rooms</li>
                            </ol>
                        </div>
                    </div>
                     <div class="row">
                                    ...
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <tbody>
											...
											<tr class="odd gradeX">
												...
												<td class="center"><?php echo ucfirst($row['roomname']); ?></td>
												<td class="center"><?php echo $row['price']; ?></td>
												<td class="center"><?php echo $row['oneline']; ?></td>
												<td class="center"><?php echo $row['comments']; ?></td>
												<td class="center"><?php echo $row['quadity']; ?></td>
												<td class="center">
